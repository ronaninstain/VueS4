    ...
    <div class="py-20 bg-gray-50">
      <div class="container mx-auto px-6 px-32">
        <div class="mb-16 text-center">
          ...
          <p class="text-gray-600 w-8/12 mx-auto">Lorem ipsum dolor sit amet consectetur adipisicing elit. Magni deleniti
            veniam laudantium itaque perferendis dolor maxime incidunt voluptatem. </p>
        </div>
        <div class="grid gap-12 items-center grid-cols-3">
          ...
          <div class="space-y-4 text-center" v-for="(person, index) in persons" :key="person.id">
            <img class="mx-auto object-cover rounded-xl w-64" :class="2 == person.id ? 'h-80' : 'h-64'"
